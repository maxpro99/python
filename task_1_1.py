...
print(f"{duration//(24 * 60 * 60)} дн " * bool(duration//(24 * 60 * 60)) +
      f"{duration//(60 * 60)%24} час " * bool(bool(duration//(60 * 60)%24) or bool(duration//(24 * 60 * 60)))+
      f"{duration//60%60} мин " * bool(bool(duration//60%60) or bool(duration//(60 * 60)%24) or bool(duration//(24 * 60 * 60)))+
      f"{duration%60} сек")
